...
class SimpleEmbedding:
    def __init__(self, projection_matrix):
        ...
        self.inv_A = np.matmul(np.transpose(self.A), np.linalg.inv(np.matmul(self.A, np.transpose(self.A))))
    ...
    def project(self, high_dim_vector):
        # Multiplying inv(A) to x
        # print("*#*#*#*#*#*#**#*#*#*#*#*")
        # print(self.inv_A[:, 0])
        # print(high_dim_vector[0, :])
        # print(self.inv_A[:, 0].dot(high_dim_vector[0, :]))

        x = np.matmul(high_dim_vector, self.inv_A)
        # print(x[0, 0])
        # print("*#*#*#*#*#*#**#*#*#*#*#*")
        #x = (x + 1.0) / 2.0
